...
The {\tt Queue} class does not contain much internal state.
Often these are
...
The {\tt Queue} class may implement buffer management and scheduling but
...
{\tt \$queuemonitor get-bytes-integrator}\\
