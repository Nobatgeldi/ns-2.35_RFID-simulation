...
The {\tt ErrorModel} class is derived from the {\tt Connector} base
...
\item Insert an error module in a SimpleLink BEFORE the queue module. 
  ...
  followed by link configurations, followed by error
    ...
    method. This method is defined in \emph{ns}/tcl/lib/ns-lib.tcl. 
...
\item Insert an error module in a SimpleLink AFTER the queue but
  ...
  \begin{\par\tabular{\textwidth}{rX}}
    ...
    is identical to that of {\tt SimpleLink::errormodule}, except
    that it inserts an error module immediately after the queue
    object. It's defined in \emph{ns}/tcl/lib/ns-link.tcl \\
